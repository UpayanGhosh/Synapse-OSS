...
- Source URLs propagated through the entire pipeline for BROWSE-05
  ...
  <verify>
    <automated>python -c "import ast; ast.parse(open('$HOME/.synapse/skills/browser/scripts/browser_skill.py').read()); print('Syntax OK')" && python -c "import sys; sys.path.insert(0, '$HOME/.synapse/skills/browser/scripts'); from browser_skill import run_browser_skill; print('Import OK')"</automated>
  </verify>
...
<task type="auto">
  ...
  <read_first>
    ...
    - workspace/sci_fi_dashboard/skills/schema.py (confirm SkillManifest exists — Phase 1 artifact)
