...
<task type="checkpoint:human-verify" gate="blocking">
  ...
  <how-to-verify>
    Follow **BAIL-02** section of `.planning/phases/15-auth-persistence-baileys-7x/15-MANUAL-VALIDATION.md`:
    ...
    **Resume signal options:**
    - `approved` — pairing succeeded, logs show connected, no errors. Wave 4 (Plans 05, 06) unblocked.
...
# Manual BAIL-02 checkpoint: see 15-MANUAL-VALIDATION.md
```
</verification>
...
- Operator confirms QR pairing + `connected` state on a real phone (BAIL-02 manual)
</success_criteria>
