...
must_haves:
  ...
  key_links:
    - from: "workspace/cli/verify_steps.py"
      ...
      via: "validate_provider() and validate_ollama() calls"
...
def validate_provider(provider_name: str, api_key: str) -> bool:
    """Validates a provider by making a test litellm.acompletion call.
    Returns True if valid (or rate-limited = valid key), False if auth error."""

def validate_ollama(api_base: str = "http://localhost:11434", model: str = "...", quiet: bool = False) -> bool:
    """Validates Ollama is reachable via HTTP GET to /api/tags."""
```
...
- Returns `(name, success_bool, error_msg_or_empty)`
...
- CRITICAL: This function is READ-ONLY. Never call `write_config()`. Never modify any file.
  ...
  <verify>
    <automated>cd C:/Users/upayan.ghosh/personal/Synapse-OSS/workspace && python -c "from cli.verify_steps import run_verify; print('verify_steps importable')" && ruff check cli/verify_steps.py</automated>
  </verify>
  <done>
...
<task type="auto">
  ...
  <files>workspace/synapse_cli.py</files>
  <action>
...
returns 1.
  ...
  <verify>
    <automated>cd C:/Users/upayan.ghosh/personal/Synapse-OSS/workspace && python synapse_cli.py setup --help 2>&1 | grep -i verify</automated>
  </verify>
  <done>
