...
- [ ] **Phase 4: Onboarding Wizard v2** — `python -m synapse setup` under 5 min, initial SBS profile from questions, history import offer (vision Phase 8)
...
| 4. Onboarding Wizard v2 | 3/4 | In Progress|  |
