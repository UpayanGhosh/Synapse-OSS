...
Plans:
- [x] standalone-01-PLAN.md — Add DEPRECATED block headers to 6 legacy shell scripts (metabolism_master.sh, revive_jarvis.sh, rollback.sh, sentinel_heal.sh, test.sh, synapse_manager.sh)
