...
def transcribe_audio(file_path):
    ...
    try:
        ...
        for i in range(num_chunks):
            ...
            res = subprocess.run([
                "ffmpeg", "-y", "-ss", str(start_time), "-t", str(chunk_size),
                "-i", file_path, "-c:a", "libopus", "-b:a", "32k", temp_chunk
            ...
            with open(temp_chunk, "rb") as f:
                ...
                try:
                    ...
                    if resp.status_code == 200:
                        ...
                        error_msg = resp.text
                        log_event(f"Chunk {i+1} failed ({resp.status_code}): {error_msg[:100]}", "ERROR")
