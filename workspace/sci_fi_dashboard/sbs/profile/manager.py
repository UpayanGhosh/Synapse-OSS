...
class ProfileManager:
    ...
    def _ensure_defaults(self):
        ...
        defaults = {
            ...
            "domain": {"interests": {}, "active_domains": [], "last_updated": None},
            "interaction": {
                "hourly_activity": {},
                "daily_activity": {},
                "peak_hours": [],
            ...
            "exemplars": {"pairs": [], "count": 0, "last_selected": None},
            "meta": {
    ...
    def save_layer(self, layer_name: str, data: dict[str, Any]):
        ...
        if layer_name == "core_identity":
            raise PermissionError("core_identity is IMMUTABLE. Manual edit only.")
