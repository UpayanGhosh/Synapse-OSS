...
def query_memories(
    ...
    try:
            ...
            if use_atomic:
                try:
                    ...
                    for row in cursor.fetchall():
                        ...
                        cursor.execute("SELECT entity, content, category FROM atomic_facts WHERE id = ?", (fid,))
        ...
        try:
            ...
            entity_keywords = {'the_creator', 'the_partner', 'the_partner_nickname', 'yourworkplace', 'jarvis', 
                             'friend_name', 'sikkim', 'kolkata', 'elden', 'sims'}
