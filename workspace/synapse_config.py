...
All 36 Python files that currently hardcode ~/.openclaw/ will import SynapseConfig from this
module. This establishes the path contract that every downstream plan depends on.
